        ...
        for (let mat in materialsData[tech]) {
          ...
          <label>
            <div class="input-container">
                <input class="input-tab input-onclick" data-controls="stl_material_" data-text="${mat}" type="image" value=${matLowercase} src="http://localhost:8888/forgelabs/wp-content/themes/x/assets/${matLowercase}.png">
            </div>
            <div class="input-name">
                <p>${mat}</p>
                <button onClick="openAbout()"><i class="fa-question-circle fa" aria-hidden="true"></i></button>
            </div>
          </label>
          `
        ...
        if (tech === selectedTech) {
          ...
          for (mat in materialsData[tech]) {
            if (mat === selectedMat) {
              ...
              $('.about-img > img').attr('src', `http://localhost:8888/forgelabs/wp-content/themes/x/assets/${matLowercase}.png`);
